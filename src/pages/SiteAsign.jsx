...
import AddAssignSite from "./AddSiteAssign";
        ...
        {!showAddForm ? (
          <>
            <div className="StaffManagementBtnBox">
              <button onClick={() => setShowAddForm(true)}>Add Inspection Schedule</button>
            </div>
                        ...
                        <tr key={item.id}>
                          ...
                          <td className="ActionIcons">
                            {/* <FiEdit className="edit" /> */}
                               <FiEdit
                                className="edit"
                                onClick={() => navigate(`/edit-stie-assign`)}
                              />
          ...
          <AddAssignSite onSave={handleAddStaff} onCancel={() => setShowAddForm(false)} />
        )}
      </div>
    </div>
  );
